...
// 2. Make sure `umas.json` (from `raw_data`) is in your project root.
// 3. Create an empty `data/` directory in your `src/` directory if it doesn't exist.
// 4. Run this script from your project root: `node scripts/prepare-umas.js`
// 5. It will generate a `src/data/uma-list.json` file.

const fs = require('fs');
const path = require('path');

const umasPath = path.join(__dirname, '../raw_data/umas.json');
const outputPath = path.join(__dirname, '../src/data/uma-list.json');
